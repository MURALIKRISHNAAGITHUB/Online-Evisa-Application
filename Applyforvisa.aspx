<%@ Page Title="" Language="C#" MasterPageFile="~/visa.Master" AutoEventWireup="true" CodeBehind="Applyforvisa.aspx.cs" Inherits="OnlineVisaApplictaion.Applyforvisa" %>
        ...
        <div class="col-sm-12 col-md-12 col-lg-12 col-padding-y">
                <div class="gen-info-box">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        ...
                        <div class="input-group" style="left: 1px; top: 0px">        
